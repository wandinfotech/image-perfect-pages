    ...
    <section className="relative min-h-screen flex items-center justify-center pt-32 pb-20 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-left space-y-6 animate-in fade-in slide-in-from-left duration-700">
            <div className="inline-flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <span className="font-medium">100+ People Like Our Services</span>
            </div>

            <h1 className="text-5xl lg:text-6xl font-bold leading-tight text-foreground">
              making your journey beyond borders{" "}
              <span className="inline-flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-full text-2xl align-middle">
                EFFORTLESS 😊😊😊
              </span>
            </h1>

            <p className="text-lg text-muted-foreground max-w-xl">
              From study and work visas to business and travel permits – we make global movement simple, secure, and stress-free.
            </p>
            ...
            <div className="flex gap-4 pt-4">
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="rounded-full border-2 border-foreground text-foreground hover:bg-foreground hover:text-background px-8"
              >
                Explore Visa
              </Button>
            </div>
          ...
          <div className="relative flex items-center justify-center animate-in fade-in slide-in-from-right duration-700 delay-300">
            <div className="relative w-[400px] h-[400px]">
              <div className="absolute inset-0 bg-primary rounded-full flex items-center justify-center shadow-card-hover">
                <div className="w-40 h-40 bg-white rounded-full flex items-center justify-center">
                  <span className="text-primary text-8xl font-bold">V</span>
                </div>
              </div>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 animate-bounce">
        <div className="w-full">
          <svg viewBox="0 0 100 20" className="w-48 h-8 text-muted-foreground/30">
        ...
        <div className="w-full flex justify-center">
          <svg viewBox="0 0 100 20" className="w-48 h-8 text-muted-foreground/30">
            <path d="M 0 10 Q 25 20, 50 10 T 100 10" fill="none" stroke="currentColor" strokeWidth="2"/>
          </svg>
        </div>
      </div>
    </section>
